...
local i=$1
	...
	echo ${NAME}
	java -Xmx16G -jar /data/Phil/software/GATK_3.7/GenomeAnalysisTK.jar -T BaseRecalibrator -R /data/Phil/ref_phil/GATK_resource/b37/human_g1k_v37.fasta -I ${i} -knownSites /data/Phil/ref_phil/GATK_resource/b37/dbsnp_138.b37.vcf.gz  -knownSites /data/Phil/ref_phil/GATK_resource/b37/Mills_and_1000G_gold_standard.indels.b37.vcf.gz -knownSites /data/Phil/ref_phil/GATK_resource/b37/1000G_phase3_v4_20130502.sites.vcf.gz -L melarray_b37.interval_list --interval_padding 100 -o ${NAME}_recal_data.table 
}
export -f foo4
...
NAME=`echo $i | sed 's/\([A-Za-z0-9-]*\)_sorted_dedup_fixmate_bqsr.bam/\1/'`;
	java -Xmx16G -jar /data/Phil/software/picard-tools-2.9.0/picard.jar CollectHsMetrics I=${i} O=${NAME}_hs_metrics.txt  R=/data/Phil/ref_phil/GATK_resource/b37/human_g1k_v37.fasta BAIT_INTERVALS=melarray_b37.interval_list TARGET_INTERVALS=melarray_b37.interval_list
